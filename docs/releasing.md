...
3. Run the local checks:
   ...
   ./scripts/check-release-version.sh v0.1.4
   ```

   Replace `v0.1.4` with the version being released.
...
```sh
herdr plugin install the-inconvenience-store/herdr-tilt --ref v0.1.4
